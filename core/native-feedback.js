...
function promptReceipt(session, id, { authoritative = false, local } = {}) {
  ...
  const status = same ? s.status || s.sendStatus : null;
...
module.exports = { supported, recordNativeContent, nativeContentAge, promptReceipt };
