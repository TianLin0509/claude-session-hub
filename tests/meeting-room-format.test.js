...
assert.strictEqual(avatarSrcFor('claude'), 'assets/pokemon/pikachu.png');
assert.strictEqual(avatarSrcFor('glm'), 'assets/pokemon/pikachu.png');
assert.strictEqual(avatarSrcFor('unknown'), '');
assert.strictEqual(avatarFallbackFor('qwen'), '\uD83D\uDD34');
assert.strictEqual(avatarFallbackFor('unknown'), '\uD83E\uDD16');
assert.strictEqual(avatarBySlot(1), 'assets/pokemon/charmander.png');
assert.strictEqual(avatarBySlot(99), '');
assert.strictEqual(avatarFallbackBySlot(2), '\uD83D\uDD35');
